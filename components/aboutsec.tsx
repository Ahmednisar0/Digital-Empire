...
Whether you're starting fresh or looking to expand, we’re here to turn your ideas into success.
        ...
        <p className="text-gray-600 lg:hidden block mt-8 text-lg w-[300px] mx-auto lg:mx-0">
        At Digital Empire, we bring creativity and technology together to build powerful digital solutions.
