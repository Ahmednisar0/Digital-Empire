...
const HeroSection = () => {
  return (
    <motion.section
      className="relative flex items-center justify-center h-screen lg:mb-0 lg:h-screen lg:mt-[-100px] mt-[-120px] bg-white overflow-hidden"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      {/* Left Shape */}
      <motion.div
        className="absolute mt-[150px] lg:mt-[-100px] left-0 top-1/2 transform -translate-y-1/2 w-1/4 md:w-1/6 lg:w-1/5"
      ...
      >
        ...
        <p className="mt-4 max-w-2xl text-gray-500 text-lg lg:text-lg mx-auto">
