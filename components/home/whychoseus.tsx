...
const WhyChooseUs = () => {
  return (
    <section className="relative py-16 px-4 h-screen">
      <div className='flex  justify-center'> <p className='text-center font-bold text-5xl'>Why chose us</p></div>
      <div className='lg:ml-[-70px]  flex lg:flex-row flex-col-reverse'>      {/* Left Bottom Background Image */}
 <div className='lg:mt-[110px] lg:justify-start items-center mt-[100px] justify-center flex flex-col'> <div className="  bottom-0 left-0 z-0">
        <Image
      ...
      {/* Service Thumb Image */}
      <div className="  lg:ml-[160px] mt-[-240px] relative  lg:mt-[-500px]  ">
        <Image
