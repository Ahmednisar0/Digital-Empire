...
const SubscribeSection = () => {
  return (
    <div className="flex mr-[20px] mt-[50px] lg:mt-[220px] lg:mr-0 ml-[20px] lg:ml-0 lg:h-[200px] items-center justify-center  ">
      <div className="lg:p-[120px] p-5 bg-[#ff4c94] rounded-2xl lg:h-[400px] shadow-lg w-full lg:w-[1000px] text-center">
        {/* Heading */}
        ...
        <div className="flex items-center  bg-white rounded-full shadow-md">
          ...
          />
          <button className="px-6 py-3 bg-[#FF0066] text-white font-medium rounded-full hover:bg-[#d4296d] focus:outline-none">
            Subscribe
          </button>
        </div>
      </div>
